...
目前 RVCK 基于统计起始点 `v6.6.155`，已累计合入 1671 个补丁（截至 2026-09-23），其中，中兴通讯 480 个提交 (28.7%)，阿里达摩院 460 个提交 (27.5%)，软件所 282 个提交 (16.9%)，进迭时空 168 个提交 (10.1%)，算能 98 个提交 (5.9%)，超睿科技 91 个提交 (5.4%)，蓝芯算力 5 个提交 (0.3%)。
